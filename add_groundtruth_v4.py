...
BASELINE_RESULTS_PATH = PROJECT_ROOT / "results" / "baseline_rppg_results_v4.csv"
OUTPUT_PATH = PROJECT_ROOT / "results" / "baseline_with_groundtruth_v4.csv"
...
# Helper functions
# ============================================================
# Extract HR values from a HR.txt file
...
# Get ground-truth HR statistics for one participant and state
...
def main():
    if not BASELINE_RESULTS_PATH.exists():
        raise FileNotFoundError(
            f"Could not find v4 baseline results: {BASELINE_RESULTS_PATH}\n"
            "Run src/run_baseline_rppg_v4.py first."
        )
