...
SUMMARY_DIR = PROJECT_ROOT / "results" / "summaries_v4_1"
FIGURES_DIR = PROJECT_ROOT / "results" / "figures" / "best_configuration_v4_1"
...
def summarise_configuration(df, group_columns):
    ...
    for key, group in successful.groupby(group_columns, dropna=False):
        ...
        # v4.1-specific interpolation diagnostics
        if "median_raw_frequency_resolution_bpm" in group.columns:
            row["mean_raw_frequency_resolution_bpm"] = float(
                group["median_raw_frequency_resolution_bpm"].mean()
            )

        if "median_padded_frequency_resolution_bpm" in group.columns:
            row["mean_padded_frequency_resolution_bpm"] = float(
                group["median_padded_frequency_resolution_bpm"].mean()
            )

        if "mean_abs_interpolation_delta_bins" in group.columns:
            row["mean_abs_interpolation_delta_bins"] = float(
                group["mean_abs_interpolation_delta_bins"].mean()
            )
...
def main():
    ...
    full_config.to_csv(
        SUMMARY_DIR / "best_full_configuration_v4_1.csv",
        index=False
    )

    print("=" * 120)
    print("Top full v4.1 configurations")
    print("=" * 120)
    ...
    robust_candidates.to_csv(
        SUMMARY_DIR / "robust_best_full_configuration_v4_1.csv",
        index=False
    )

    print("=" * 120)
    print("Top robust v4.1 configurations")
    ...
    by_source_method.to_csv(SUMMARY_DIR / "accuracy_by_source_method_v4_1.csv", index=False)
    by_roi.to_csv(SUMMARY_DIR / "accuracy_by_roi_v4_1.csv", index=False)
    by_window_size.to_csv(SUMMARY_DIR / "accuracy_by_window_size_v4_1.csv", index=False)
    by_overlap.to_csv(SUMMARY_DIR / "accuracy_by_overlap_v4_1.csv", index=False)
    by_state.to_csv(SUMMARY_DIR / "accuracy_by_state_v4_1.csv", index=False)
    by_source_window.to_csv(SUMMARY_DIR / "accuracy_by_source_method_window_size_v4_1.csv", index=False)
    by_source_overlap.to_csv(SUMMARY_DIR / "accuracy_by_source_method_overlap_v4_1.csv", index=False)
    by_window_overlap.to_csv(SUMMARY_DIR / "accuracy_by_window_size_overlap_v4_1.csv", index=False)
    by_roi_source.to_csv(SUMMARY_DIR / "accuracy_by_roi_source_method_v4_1.csv", index=False)
    by_state_source.to_csv(SUMMARY_DIR / "accuracy_by_state_source_method_v4_1.csv", index=False)
    by_state_window_overlap.to_csv(SUMMARY_DIR / "accuracy_by_state_window_overlap_v4_1.csv", index=False)
    ...
    best_per_source.to_csv(SUMMARY_DIR / "best_configuration_per_source_method_v4_1.csv", index=False)
    best_per_roi.to_csv(SUMMARY_DIR / "best_configuration_per_roi_v4_1.csv", index=False)
    best_per_state.to_csv(SUMMARY_DIR / "best_configuration_per_state_v4_1.csv", index=False)
    ...
    best_rows.to_csv(
        SUMMARY_DIR / "best_overall_configuration_individual_rows_v4_1.csv",
        index=False
    )
    ...
    print(best_rows[preview_columns].head(40))
    print()
    ...
    snr_threshold_summary.to_csv(
        SUMMARY_DIR / "snr_threshold_analysis_v4_1.csv",
        index=False
    )
    ...
    save_top_configuration_plot(
        full_config,
        filename="top_10_full_configurations_v4_1_by_mae.png",
        title="Top 10 v4.1 Configurations by MAE",
    ...
    save_top_configuration_plot(
        robust_candidates,
        filename="top_10_robust_configurations_v4_1_by_mae.png",
        title="Top 10 Robust v4.1 Configurations by MAE",
        config_columns=full_config_columns,
        top_n=10
    )
    ...
    save_bar_plot(
        ...
        y_column="mae_bpm",
        filename="mae_by_source_method_v4_1.png",
        title="v4.1 Mean Absolute Error by Source Method",
    ...
    save_bar_plot(
        ...
        x_column="roi",
        y_column="mae_bpm",
        filename="mae_by_roi_v4_1.png",
        title="v4.1 Mean Absolute Error by ROI",
        xlabel="ROI",
        ylabel="MAE (BPM)"
    )
    ...
    save_bar_plot(
        ...
        y_column="mae_bpm",
        filename="mae_by_window_size_v4_1.png",
        title="v4.1 Mean Absolute Error by Window Size",
    ...
    save_bar_plot(
        ...
        x_column="overlap",
        y_column="mae_bpm",
        filename="mae_by_overlap_v4_1.png",
        title="v4.1 Mean Absolute Error by Window Overlap",
        xlabel="Overlap",
        ylabel="MAE (BPM)"
    )
    ...
    save_bar_plot(
        ...
        x_column="state",
        y_column="mae_bpm",
        filename="mae_by_state_v4_1.png",
        title="v4.1 Mean Absolute Error by Recording State",
        xlabel="State",
        ylabel="MAE (BPM)"
    )
    ...
    save_window_heatmap(
        by_window_overlap,
        filename="mae_heatmap_window_size_overlap_v4_1.png",
        title="v4.1 MAE by Window Size and Overlap"
    )
    ...
    save_bar_plot(
        ...
        y_column="mae_bpm",
        filename="mae_by_snr_threshold_v4_1.png",
        title="v4.1 MAE After Applying SNR Threshold",
    ...
    save_bar_plot(
        ...
        x_column="snr_threshold_db",
        y_column="coverage",
        filename="coverage_by_snr_threshold_v4_1.png",
        title="v4.1 Coverage After Applying SNR Threshold",
        xlabel="SNR threshold (dB)",
        ylabel="Coverage"
    )
